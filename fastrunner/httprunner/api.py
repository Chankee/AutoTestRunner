...
from . import (exceptions, loader, logger, parser, report, runner,
                        utils, validator)
...
class HttpRunner(object):
    ...
    def __init__(self, **kwargs):
        ...
        Attributes:
            project_mapping (dict): save project loaded apil/testcases, environments and debugtalk.py module.
                {
                    "debugtalk": {
                        "variables": {},
                        "functions": {}
    ...
    def _aggregate(self, tests_results):
        ...
        for tests_result in tests_results:
            ...
            print('--------', len(testcase_summary['records']))
